...
const SvgProfile = (props) => (
  <svg
    id="profile_svg__uuid-c3e948a5-9e30-4db8-b2fe-d9f71b56093a"
    viewBox="0 0 173 173"
    ...
    {...props}
  >
    <defs id="profile_svg__defs1772">
      <style id="style1770">
        {
          ".profile_svg__uuid-31f5f76c-1f47-45e3-b913-6477f59e3b0a{fill:#b3b3b3}"
        }
      </style>
    </defs>
    <path
